...
class JavaClassObject extends SimpleJavaFileObject {
	 ...
	 * ByteArrayOutputStream so that we can later get the byte array out of it and
	 ...
	 * array. This way the compiler will write everything into the byte array that
	 * we will instantiate later
	 */
	@Override
